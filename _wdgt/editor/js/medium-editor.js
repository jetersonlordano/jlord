...
(function () {
    ...
    MediumEditor.extensions.button.prototype.defaults = {
        ...
        'html': {
            ...
            contentDefault: '<i class="fa fa-html5"></i>',
        ...
        'h1': {
            name: 'h1',
            action: 'append-h1',
            aria: 'Cabeçalho tipo um',
            tagNames: ['h1'],
            contentDefault: '<i class="fa fa-header"><sup>1</sup>',
            contentFA: '<i class="fa fa-header"><sup>1</sup>'
        },
        'h2': {
            name: 'h2',
            action: 'append-h2',
            aria: 'Cabeçalho tipo dois',
            tagNames: ['h2'],
            contentDefault: '<i class="fa fa-header"><sup>2</sup>',
            contentFA: '<i class="fa fa-header"><sup>2</sup>'
        },
        'h3': {
            name: 'h3',
            action: 'append-h3',
            aria: 'Cabeçalho tipo três',
            tagNames: ['h3'],
            contentDefault: '<i class="fa fa-header"><sup>3</sup>',
            contentFA: '<i class="fa fa-header"><sup>3</sup>'
        },
        'h4': {
            name: 'h4',
            action: 'append-h4',
            aria: 'Cabeçalho tipo quatro',
            tagNames: ['h4'],
            contentDefault: '<i class="fa fa-header"><sup>4</sup>',
            contentFA: '<i class="fa fa-header"><sup>4</sup>'
        },
        'h5': {
            name: 'h5',
            action: 'append-h5',
            aria: 'Cabeçalho tipo cinco',
            tagNames: ['h5'],
            contentDefault: '<i class="fa fa-header"><sup>5</sup>',
            contentFA: '<i class="fa fa-header"><sup>5</sup>'
        },
        'h6': {
            name: 'h6',
            action: 'append-h6',
            aria: 'Cabeçalho tipo seis',
            tagNames: ['h6'],
            contentDefault: '<i class="fa fa-header"><sup>6</sup>',
...
(function () {
    ...
    var AnchorForm = MediumEditor.extensions.form.extend({
         ...
         */
        targetCheckboxText: 'Nova janela',
