...
// E-mail autênticado
define('SMTP', true);
define('SMTPHOST', 'smtp.site.com');
define('SMTPAUTHOR', 'JLord CMS');
define('SMTPEMAIL', 'contato@jlord.com.br');
define('SMTPPASSWORD', '');
define('SMTPSECURE', 'SSL');
define('SMTPPORT', '587');

// Tabelas
define('TBCATS', ['categories', 'cat_']);
define('TBCONFIG', ['config', 'conf_']);
define('TBDOWNS', ['downloads', 'dwn_']);
define('TBLEADS', ['leads', 'lead_']);
define('TBNET', ['networks', 'net_']);
define('TBPAGES', ['pages', 'pg_']);
define('TBPOSTS', ['posts', 'post_']);
define('TBSEARCHES', ['searches', 'sch_']);
define('TBSESSIONS', ['sessions', 'ses_']);
define('TBUSERS', ['users', 'user_']);
define('TBONLINE', ['userson', 'onl_']);
define('TBVIEWS', ['views', 'views_']);
